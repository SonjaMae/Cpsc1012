...
namespace Variables
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //     whole numerical types: interger; many others
            ...
            //decimals require to be explicitly typed using an m
            myWeight = 110.0m;
            myHeight = 1.75m;

            //math calculations follow the acceptable rules of arithmetic
            // - assignment
            // () execute within
            // * / %
            // + -
